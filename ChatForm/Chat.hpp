...
{
public:
	Chat(HINSTANCE hInstance, int cmdShow)
	{
		if (AllocConsole())
		{
			FILE* pCout;
		...
		const wchar_t windowTitle[] = L"ClientChat";
		WNDCLASSEX wcex;
		...
		if (!(parentHwnd = CreateWindow(className, windowTitle, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL)))
		{
